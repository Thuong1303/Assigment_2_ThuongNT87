...
import com.assigment_2_thuongnt87.dto.order.OrderItemDto;
...
import com.assigment_2_thuongnt87.entities.order.OrderItem;
...
import com.assigment_2_thuongnt87.repository.OrderRepository;
import com.assigment_2_thuongnt87.repository.ProductVariantRepository;
import com.assigment_2_thuongnt87.service.OrderService;
import com.assigment_2_thuongnt87.util.MailService;
...
public class OrderServiceImpl implements OrderService {
  ...
  private void sendConfirmationEmail(Order order) {
    ...
    String subject = "[Hung Hypebeast] Xác nhận đơn hàng - " + order.getOrderCode();

    String body =
            "Kính chào " + order.getFullName() + ",\n\n"
                    + "Cảm ơn bạn đã mua sắm tại Hung Hypebeast. Đơn hàng của bạn đã được ghi nhận thành công.\n\n"
                    + "--------------------------------------\n"
                    + "THÔNG TIN ĐƠN HÀNG\n"
                    + "--------------------------------------\n"
